AnimationList.PropEmotes = {
    ...
    --[[{
        Label = 'Selfie Sitting',
        Command = 'selfiesit',
        Animation = 'female_sitting_selfie_clip',
        Dictionary = 'mouse@female_sitting_selfie',
        Options = {
            Flags = {
                Loop = true,
            },
            Props = {
                {
                    ...
                    Name = 'prop_phone_ing',
                    Placement = {
                        vector3(0.138000, 0.030000, -0.043000),
                        vector3(-111.094597, -117.806900, 11.738600),
                    },
                    Variant = 0,
                    Variations = {0, 1, 2, 3, 4, 5, 6, 7},
                },
                {
                    ...
                    Placement = {
                        vector3(-0.010000, -0.080000, -0.680000),
                        vector3(-180.000000, -180.000000, 10.000000),
                    },
                },
            },
        },
    ...
    --[[{
        ...
        Command = 'sitchairf',
        Animation = 'female_armchair_clip_01',
        Dictionary = 'mouse@femalearmchair',
        Options = {
            Flags = {
                Loop = true,
            },
            Props = {
                {
                    ...
                    Placement = {
                        vector3(0.532000, -0.331000, 0.200000),
                        vector3(-90.000000, -180.000000, -40.999901),
                    },
                },
            },
        },
    },
    {
        ...
        Command = 'sitchairf2',
        Animation = 'female_sitting_folded_clip',
        Dictionary = 'mouse@female_sitting_folded',
        Options = {
            Flags = {
                Loop = true,
            },
    ...
    },
    {
        ...
        Command = 'sitchairf3',
        Animation = 'female_sitting_forward_clip',
        Dictionary = 'mouse@female_sitting_forward',
        Options = {
            Flags = {
                Loop = true,
            },
    ...
    },
    {
        ...
        Command = 'sitchairf4',
        Animation = 'female_smart_sitting_clip',
        Dictionary = 'mouse@female_smart_sitting',
        Options = {
            Flags = {
                Loop = true,
            },
    ...
    },
    {
        ...
        Command = 'sitchairf5',
        Animation = 'female_smart_sitting_crossed_clip',
        Dictionary = 'mouse@female_smart_sitting_crossed',
        Options = {
            Flags = {
                Loop = true,
            },
    ...
    {
        Label = 'Sit Chair - Laptop',
        Command = 'sitchairf6',
        Animation = 'female_sitting_laptop_clip',
        Dictionary = 'mouse@female_sitting_laptop',
        Options = {
            Flags = {
                Loop = true,
            },
            Props = {
                {
                    Bone = 57005,
                    Name = 'ba_prop_club_laptop_dj_02',
                    Placement = {
                        vector3(0.086000, -0.137000, -0.175000),
                        vector3(-79.999901, -90.000000, 0.000000),
                    },
                },
                {
                    Bone = 0,
                    ...
                    Placement = {
                        vector3(-0.040000, -0.190000, 0.000000),
                        vector3(-180.000000, -180.000000, 9.099900),
                    },
                },
            },
        },
    ...
    {
        Label = 'Sit Chair - Tablet',
        Command = 'sitchairf7',
        Animation = 'female_sitting_tablet_clip',
        Dictionary = 'mouse@female_sitting_tablet',
        Options = {
            Flags = {
                Loop = true,
            },
            Props = {
                {
                    Bone = 28422,
                    Name = 'hei_prop_dlc_tablet',
                    Placement = {
                        vector3(0.087000, 0.103000, -0.124000),
                        vector3(144.354004, 157.852707, -4.631800),
                    },
                },
                {
                    Bone = 0,
                    Name = 'ba_prop_battle_club_chair_02',
                    Placement = {
                        vector3(0.010000, -0.080000, 0.020000),
                        vector3(150.000000, -180.000000, 10.000000),
                    },
                },
            },
        },
    },
    {
        ...
        Options = {
            ...
            Props = {
                {
                    Bone = 28422,
                    Name = 'v_ilev_mp_bedsidebook',
                    Placement = {
                        vector3(0.130000, 0.110000, -0.120000),
                        vector3(120.335602, -15.989100, 26.149700),
                    },
                },
                {
                    Bone = 0,
